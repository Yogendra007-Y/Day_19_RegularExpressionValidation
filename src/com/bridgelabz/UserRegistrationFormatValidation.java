...
public class UserRegistrationFormatValidation {
    ...
    String RegexPassword = "^[A-Z]{1,}+[a-zA-Z]{8,}+[@#$%*]{1}+[1-9]{1,}"; //User Registration Pattern For Password
    ...
    public void passwordValidation(String password){
        ...
        if(!validationPassword) {
            System.out.println("Enter Password According To Pattern: [A-Z]{1,}+[a-zA-Z]{8,}+[@#$%*]{1}+[1-9]{1,}");
        }
    }
}